...
description: "Segment allows you to create specific client groups for better targeting, analysis, and automation."
---
...
<Steps>
  ...
  <Step title="Create your Segment">
    ...
    1. **Define Your Segment** – Start by naming your segment and providing a clear description of its purpose. This helps in organizing and understanding the segment’s intent, especially for automation.
  ...
  <Step title="Configuring the Criteria">
    **Adding Filters**
    ...
    2. You'll see a drop down of entities from your existing database. Once an entity is selected, you can only apply filters based on the attributes within that entity.
